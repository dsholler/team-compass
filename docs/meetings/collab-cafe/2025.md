...
* Yay Min is officially @ BIDS [Blog Post](https://bids.berkeley.edu/news/min-ragan-kelley-and-his-journey-back-bids)
* Brainstorming strategic directions from Fernando - 
* 
* 
* 
* 
...
* Getting nerd sniped by GitHub projects in :sparkles: [new and exciting ways](https://github.com/orgs/the-turing-way/projects/15) :sparkles:
    * Prep for bookdash - using the templates that Arielle 
    * Good format for the HubDash 
    * Good for the overall calendar for JupyterHub - as a draft version for the community (talk about the use of it as a project durign the HubDash)
    * Spreads the event over time - asks for participation in the leadup and after the event too. 
    * Acknowledge volunteers - highlights afterwards. Public share out afterwards. 
    * What is needed for OS projects. Its the thinking that you need people to do. We tend to focus on skills: What about questions like: How do you do issue triage? 
        * Folks at TW have talked about doing these events 
        * Now we want folks in JH community to be doing some of the thinking for themselves - we're not telling you what to do. 
    * What if we have too many templates? 
        * Who owns/maintains these templates? 
* Planning for JupyterCon - user workshop and JupyterBook tutorial
    * Problem resolved re: attendees paying $150 to attend. 
        * Kirstie to send an updated email.
    * One response for user workshop. 
    * Videos? We could ask folks for a short video. 
    * Communicating that people who are users are welcome. Helping folks, what do folks feel is missing in JH, what do people need from the project? At a community/project/technical level
    * Who do we want to be in the room? What are the types of people we want to listen to? Activating the community. 
        * Min send emails. Coordinate with Arielle. 
        * BIDS newsletter and at the ospo event, rustle up some folks there. 
        * Thread with April. 
* HubDash Planning -
    * Creating onboarding resources and cleaning up Team Compass pages - https://hackmd.io/AvEYKb7iTRGJoofPB8BwqQ
    * Invite process? Send calendar invites?
    * Who are we inviting? 
    * Anyone who is engaged in the JH Zulip? 
    * Specific invites to leadership, general open form for others? 
    * Advertising broadly seems appropriate. 
    * People invited to the in person event in June, even if they didn't attend. 
    * Very simple registration form, looking for people who have contributed before.   
        * What is a PR request you've been engaged with?
        * Github user name
    * If you want to run an onboarding track, then we can do that with the materials. 
        * Who to invite? 
* Onboarding landing page #jupyterhub > Oboarding Landing Page - To discuss @ Sep 10 Aux Cafe
